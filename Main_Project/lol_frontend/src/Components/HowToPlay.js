    ...
    return (
        <React.Fragment>
            <Typography component="p" variant="h4">
                <div> <p> League of Legends is a multiplayer online battle arena. It’s been one of the most popular games of all time and currently one of the biggest esports.</p>
                    <p>In a standard game of League, ten players are split into two teams of five and battle it out on a map called Summoner’s Rift.</p>
                    <p>Each of these players controls a single character, known as a champion.</p>
                </div>

                <div>  <h1>What is a champion?</h1>
                    ...
                    <p>There’s a lot of strategies involved as you work with your team to create teams with champions that work well together (more on this later).</p>
                    <p>Every game you play can be vastly different since every champion has their own feel and gameplan.</p>
                </div>

                <div> <h1>  How do you win?</h1>
                    ...
                    <p>If you started a game and tried to run straight to the enemy base, you’d certainly die, not just because the enemy team would be trying to stop you at all costs, but also because you may be too weak and die.</p>
                    <p>League is sort of like a role-playing game (RPG) that takes place in a very short amount of time.</p>
                    <p>You begin at level 1 and gradually get stronger throughout the game by gaining experience and earning gold to buy items.</p>
                    <p>The two teams continually grow in power and collide. Eventually, one team is able to get the upper hand and make a final push for a victory.</p>
                </div>
                ...
                <div> <h1> Here are the basics of the Summoner’s Rift map:</h1>
                    <p> There are two teams of five players: the blue team (base at bottom left corner) and the red team (base at the top right corner).</p>
                ...
                <div>    <h1> LoL Champion Basics</h1>
                    <p>Now that we understand the basics of the map, let’s get back to talking about champions. Champions are the heart and soul of League of Legends as they’re often what players resonate with most.</p>
                    <p>While Summoner’s Rift stays constant, the different combinations of champions that are chosen by the ten players in game can create vastly different rhythms and feels.</p>
                ...
                <div>  <h1>The Three Phases and Scaling</h1>
                    <p>These concepts are leaning more towards being intermediate than beginner, but we want to quickly go over them since you’ll likely hear the terminology of the three phases: early game, mid game, and late game.</p>
                    <p>The phases aren’t set in stone and act more as guidelines as every game is different in its own way, but they tend to hold true to regarding how the majority of games turn out:</p>
                    ...
                    <p>•	During the mid game, a match becomes messier than lane phase as some players will remain in lane while others will begin to roam around the map to help destroy other turrets or contest dragons or Rift Herald.</p>
                    <h2>Late game (after 30 minutes)</h2>
                    <p>•	The mid game usually ends and around the 30 minute mark when all of the first turrets in the lanes are destroyed (sometimes even more are gone by then). This is the late game.</p>
                    <p>•	At this point, champions have acquired many of their major items and teams begin to group for large teamfights around Baron and Elder Dragons.</p>
                    <p>So why are the three phases important? In League of Legends, every champion is designed to be good during a certain time period. Some champions are designed to be strong in the early game but fall off the longer the game goes while others are designed to be weak early but get continuously stronger as the game goes on.</p>
                    <p>When a champion is at their strongest, it is known as a “power spike”. The process of getting gradually stronger and achieving your power spike is known as “scaling”. We won’t get too into detail here but know that scaling is usually influenced by a champion’s ability kit and their stat ratios as they buy more items. Let’s cover a few examples.</p>
                </div>
